...
Payment-processing reference system with ISO 8583/EMV boundaries, routing, timeout and reversal handling, PostgreSQL idempotency, double-entry accounting, a transactional outbox, reconciliation and operational metrics.
